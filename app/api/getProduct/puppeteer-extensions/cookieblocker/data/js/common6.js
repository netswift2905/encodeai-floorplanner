function getE(hostname) {
  switch (hostname) {
    ...
    case 'topographic-map.com':
      return [
        'cookies=%7B%22analytics%22%3Afalse%2C%22advertisements%22%3Afalse%7D',
      ]
  }
...
if (cookies) {
  ...
  if (counter > 0 && document.cookie.length > 0) document.location.reload()
}

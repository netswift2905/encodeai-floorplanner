...
function _iframe(iframe_selector, selector) {
  ...
  return e
    ? _sl(selector, e.contentDocument || e.contentWindow.contentDocument)
    : e
}
    ...
    for (let i = 0; i < host.long.length; i++) {
      switch (host.long[i]) {
        ...
        case 'photospecialist':
          return _chain(
            '.ke-cookie-modal .accept + button',
            '.ke-cookie-modal .save-button'
          )
        ...
        case 'translit':
          return '.tPechenkiInfoblock .tPechenkiButtonNoshow'
        case 'inshared':
          return _if(
        ...
        case 'adidas':
          return host.parts.indexOf('signup') != -1
            ? _chain(
                '.gl-modal--active button[data-test="cs-cookies-tracking__manage"]',
                '.cs-cookies-tracking__content input[value="0"]',
                'button[data-test="cs-cookies-tracking__save"]'
              )
            : _if_else(
                '#app, #__next',
                [
                ...
                ['#consent-tracking[style*="block"] .decline']
              )
        case 'euronics':
        ...
        case 'modivo':
          return _if_else(
            ...
            [
              '.side-modal.bottom.opened button + button',
              '.side-modal.right.opened .primary',
            ]
          )
        case 'calvendo':
        ...
        case 'backmarket':
          return _if(
            'div[aria-modal="true"] img[src*="gdpr"], div[aria-modal="true"] img[src*="cookie"]',
        ...
        case 'skyscanner':
          return '#user-preferences-dialog button + button, #PrivacySettings_buttons button + button'
        case 'favi':
        ...
        case 'fashionunited':
          return _if(
            '.MuiDialog-root button[test-id="Cookies"]',
  ...
  switch (host.full) {
    ...
    case 'facebook.com':
      if (/^\/user_cookie_prompt\//.test(document.location.pathname))
        ...
        return _if(
          'div[id^="mount"] > div > div:first-child > div:last-child:not(:first-child) a[href*="/policies/cookies/"]',
          'div[id^="mount"] > div > div:first-child > div:last-child:not(:first-child) > div > div:first-child > div > div:last-child > div > div > div:last-child div[role="button"]'
        )
    ...
    case 'meta.com':
      return _if(
        'div[role="dialog"] a[href*="/policies/cookies"], div[role="dialog"] a[href*="/policy/cookies"]',
        '//div[@role="dialog"][.//a[contains(@href, "/policies/cookies")]]/div/div/div/div[3]//div[@role="button"] | //div[@role="dialog"][.//a[contains(@href, "/policy/cookies")]]/div[2]/div/div[2][@role="button"]'
      )
    case 'auth.meta.com':
      return _if(
    ...
    case 'consent-pref.trustarc.com':
      if (document.location.search.indexOf('site=formula1-iab.com') > -1)
        return _chain(
          'div[aria-label*="Functional"] .consentyes',
          '.saveAndExit'
        )
      else return '.pdynamicbutton .call, .bottom .rejectAll'
    ...
    case 'gamer.nl':
      return _if(
        '.fixed.w-full.block a[href*="privacy"]',
        '.fixed.w-full.block button'
      )
    ...
    case 'armedangels.com':
      return '.modal[style*="block"] .js-cookie-permission-button button'
    case 'fleurop.de':
      return _chain(
    ...
    case 'threads.com':
      return _if(
        ...
        '//div[@id="portals-root"]//*[text()="Reject all"]'
      )
    ...
    case 'hemnet.se':
      if (_id('___gatsby'))
        ...
        var button =
          e && e.shadowRoot
            ? _sl('[data-testid="uc-customize-button"]', e.shadowRoot)
            : false
    ...
    case 'abonnement.lefigaro.fr':
      if (/\?redirect_uri/.test(document.location.search)) history.back()
      return 'body'
    ...
    case 'notion.so':
      return _if(
        ...
        '.notion-overlay-container [role="button"]:nth-child(2)',
        '.notion-overlay-container [role="button"]:only-child'
      )
    ...
    case 'gv.at':
      return '#cookieman-modal[style*="block"] [data-cookieman-save], .modal .cookie-button:nth-of-type(2) button, .guglercookies[style*="block"] .cookie-refuse, .bemCookieOverlay__btn--save'
    ...
    case 'litebit.eu':
      return _if(
        '.chakra-modal__content img[src*="cookie"]',
        '.chakra-modal__body > div > div:nth-child(2) strong'
      )
    case 'huutokaupat.com':
      return '.chakra-modal__content .consent-modal-content + div button:last-child'
    ...
    case 'brewersfayre.co.uk':
      return _if_else(
        'div[class*="chakra"]',
        [
          '.chakra-modal__content[data-testid*="CookiePolicy"] button[data-testid*="Manage"]',
          '.chakra-modal__content[data-testid*="CookiePolicy"] div[data-testid*="CookieGroup"] ~ div button',
        ],
        [
    ...
    case 'flip.bg':
      return _chain(
        '.cookie-modal[style*="block"] button + button',
        '.cookie-modal[style*="block"] button:only-child'
      )
    ...
    case 'online.swedbank.se':
      return '.cdk-overlay-container fdp-consent-dialog acorn-button[priority="destructive"]'
    ...
    case 'aerztezeitung.de':
      return _if(
        'div[data-nosnippet] a[href*="Datenschutzerklaerung"]',
    ...
    case 'scaleway.com':
      return _if(
        '#portal p > a[href*="cookie"]',
        '//div[@id="portal"]/div[last()]//div[./div/p/a[contains(@href, "cookie")]]/div[2]//button'
      )
    case 'console.scaleway.com':
      return _if(
        'div[aria-modal="true"] a[href*="cookie-policy"]',
        'div[aria-modal="true"] h2 + button'
      )
    ...
    case 'hauts-de-seine.gouv.fr':
      return '.artifica-rgpd .btn-accept'
    case 'mesdroitssociaux.gouv.fr':
      return '.cdk-overlay-container dd1pnds-ng-cookies-popin .popin-close-button button'
    ...
    case 'education.lego.com':
      return _if(
        'div[data-testid="modal"] a[href*="cookie-policy"]',
        'div[data-testid="modal"] hr + div button:first-child'
      )
    case 'lego.com':
    ...
    case 'devicespecifications.com':
      return _chain(
        '#window_cookie_consent_1_overlay:not([style*="none"]) #window_cookie_consent_1_button_configure',
        '#window_cookie_consent_2_select_cookies_analytics option:last-child',
        '#window_cookie_consent_2_select_cookies_ad option:last-child',
        '#window_cookie_consent_2_button_accept'
      )
    ...
    case 'defence24.com':
      return _chain(
        '.modal.show .PrivacyModal .modal-footer .col-6:first-child .btn',
        '#performance-0',
        '#functional-0',
        '#marketing-0',
        '#analytics-0',
        '.modal.show .PrivacyModal .modal-footer .col-6:last-child .btn'
      )
    ...
    case 'buyzoxs.de':
      return _chain(
        '.modal[style*="block"] .js-gdpr-settings',
        '#btnDeny.js-gdpr-submit'
      )
    case 'zoxs.de':
      return _chain(
        '.modal[style*="block"] .gdpr-extend',
        '#btnDeny.js-gdpr-submit'
      )
    ...
    case 'uphold.com':
      ...
      e = e
        ? _ev(
            'div[@id="__next"]/div[./div[1]//a[contains(@href, "cookie-policy")]]'
          )
        : e
      return e &&
        window.getComputedStyle(e).getPropertyValue('transform') == 'none'
    ...
    case 'danskemedier.dk':
      return '#gdpr-cookie-message:not([style*="none"]) #cookie-select-none'
    case 'logpay.de':
    ...
    case 'm.21vek.by':
      return _if(
        '.react-swipeable-view-container a[href*="cookie_policy"]',
        '.react-swipeable-view-container button[class*="close"]',
        '[class*="AgreementCookie_targeting"] button',
        '.react-swipeable-view-container button[class*="close"]'
      )
    ...
    case 'yahoo.com':
      return '#gucRefreshPage .loader-text a[href*="guccounter=2"]'
    case 'consent.yahoo.com':
      return '.consent-form .reject-all'

    case 'crtm.es':
      return '.window[style*="block"] #ConfigCookies #aceptar2'
    case 'tarjetatransportepublico.crtm.es':
      return _if(
        '.jconfirm-open #CookiesInfo',
        '.jconfirm-open .btn:nth-child(2)',
        '.jconfirm-open .btn:only-child'
      )
    ...
    case 'depo.lv':
      return _if(
        'div.fixed',
        '//div[contains(@class, "fixed")]//button[*="Akceptēt visu"]'
      )
    case 'depo.ee':
      return _if(
        'div.fixed',
    ...
    case 'developer.samsung.com':
      return '.cookie-modal.show #accept-none-btn'
    case 'samsung.com':
      return _if(
        '.MuiBox-root p > a[href="/policy/cookie"]',
        '//div[contains(@class, "MuiBox-root")][./div/div/p/a[@href="/policy/cookie"]]//button[2]'
      )
    ...
    case 'what3words.com':
      return '.CookieNotice-Button'
    case 'auth.what3words.com':
      return _if(
        'div[aria-modal="true"] a[href*="cookies"]',
        'div[aria-modal="true"] span button',
        'div[aria-modal="true"] w3w-button[type="submit"] button'
      )
    ...
    case 'justjoin.it':
      return _if(
        '#__next > div:last-child .MuiBox-root a[href*="privacy"]',
        '#__next > div:last-child .MuiBox-root + button'
      )
    case 'hola.org':
      return _chain(
    ...
    case 'nojazz.eu':
      return _chain('#consentui .btn.amber', '.btn.green:only-child')
    ...
    case 'plex.tv':
      return _chain(
        '.remodal-is-opened .cookie-consent-settings',
        '.remodal-is-opened .cookie-settings-save'
      )
    case 'groby.hu':
      return _if(
    ...
    case 'veolia.fr':
      return _if(
        '.ant-modal-root a[href*="cookie"]',
        '.ant-modal-root div > a',
    ...
    case 'klarna.com':
      return _if(
        '#ModalLayout',
        '//div[@id="ModalLayout"]//button[*="Required only"]'
      )
    case 'gezondheidsplein.nl':
      return '.consent .agree + .link'
    case 'phish-test.de':
      return _if(
        '.swal2-shown',
        '//div[contains(@class, "swal2-modal")][.//a[contains(@href, "datenschutz")]]//div[@class="swal2-actions"]/button[2]'
      )
    case 'stern.de':
      return '.message-component[title*="Zustimmen"], #cmpbox[style*="block"] .cmpboxbtnyes'
    case 'gemini.pl':
      return '.fixed.w-full button[data-ga-id="cookie-wall-accept-all"]'
    case 'cheersapp.io':
      return _if(
    ...
    case 'astroportal.com':
      return '#plusgate:not([style*="none"]) button[onclick*="consent"]'
    case 'game.es':
    ...
    case 'qiwi.com':
      return _if(
        '#app > div > div > div > p > span > a',
        '//section[@id="app"]/div/div/div[./p/span/a[text()="Политике"]]/div'
      )
    ...
    case 'erli.pl':
      return _if(
        'p > a[href*="polityka-prywatnosci"]',
        '//div[./div/p/a[contains(@href, "polityka-prywatnosci")]]//button[2]',
        '//div[./div/p/a[contains(@href, "polityka-prywatnosci")]]//button[2]'
      )
    case 'airbike.pl':
      return _if(
    ...
    case 'wwz.ch':
      return '.cookie--open .cookie__save-settings'
    case 'pubg.com':
      return _chain(
    ...
    case 'dunelm.com':
      return _if_else(
        '#__next',
        [
          '//div[@data-state="open"][.//a[@href="/info/help/cookies"]]//button[last()]',
          '//div[@data-state="open"]/section/div/div/button',
        ],
        [
    ...
    case 'monese.com':
      return _chain(
        'div[class*="CookieBanner"] button + button',
        'div[class*="CookieBanner"] div + button'
      )
    ...
    case 'asus.com':
      return _if(
        ...
        '#cookie-policy-lightbox-wrapper .btn-save'
      )
    ...
    case 'bitrefill.com':
      return _if(
        'body > div[data-state="open"]',
        '//body/div[@data-state="open"][.//span[contains(text(), "🍪")]]//form/div[last()]/button'
      )
    case 'tesco.hu':
    ...
    case 'anslutning.telia.se':
      return _chain(
        '.cookie-consent-modal telia-button:not([id])',
        '.cookie-consent-modal div:only-child > telia-button'
      )
    case 'fello.se':
      return _chain(
    ...
    case 'smart.com':
      return _chain(
        '#cookie-pro-dialog[open] #cookie-pro-info-button',
        '#onetrust-pc-sdk:not([style*="none"]) .ot-pc-refuse-all-handler'
      )
    ...
    case 'united-domains.de':
      return '.gen-layer[style*="block"] .cookie-layer-dialog .confirm-selection, .wp-exclude-emoji div[id^="bnnr"] > div[style*="; order: 1"] span'
    case 'qdq.com':
      return _chain(
    ...
    case 'ccoo.es':
      return '.ccoo-cc-root #sn-b-save'
    case 'schindler.de':
      return '.ddm[style*="block"] #ddmcm-button-select-none'
    case 'ponal.de':
      return '.epp-overflow .epp-modal .cookie-consent__agree'
    case 'leki.pl':
      return '.rodo-modal:not([style*="none"]) button'
    case 'jobware.de':
      return '.cdk-overlay-container .dsgvo-consent-action button:first-child'
    case 'fftir.org':
    ...
    case 'backstagepro.de':
      return '#dialogconsent[style*="block"] #saveselection'
    case 'virginaustralia.com':
      return '#cookieAcceptanceBtn'
    case 'nova-web.de':
      return 'div[class*="CookieBanner"] .mb-3 + .mb-3 button'
    case 'web.dev':
      return _if(
        'div[jscontroller][jsaction] > span > [data-is-touch-wrapper] a[href*="cookies"]',
        'div[jscontroller][jsaction] > span > [data-is-touch-wrapper] + [data-is-touch-wrapper] > button'
      )
    case 'bayernlb.de':
      return '.btn[onclick*="deleteAllCookies"]'
    case 'campusbrno.cz':
    ...
    case 'eneba.com':
      return _if_else(
        '#page-footer',
        [
          '//footer[@id="page-footer"]/following-sibling::div//div[./h3[text()="Cookies"]]//button[last()]',
          'FLAG:ALL-MATCHES',
          '.ReactModal__Content--after-open [checked]',
          'FLAG:SINGLE-MATCH',
          '.ReactModal__Content--after-open [type="submit"]',
        ],
        [
          '//main/div//div[./h3[text()="Cookies"]]//button[last()]',
          'FLAG:ALL-MATCHES',
          '.ReactModal__Content--after-open [checked]',
          'FLAG:SINGLE-MATCH',
          '.ReactModal__Content--after-open [type="submit"]',
    ...
    case 'dbschenker.com':
      return '.dialog[open] button[data-reject-all-privacy-settings], .dialog--open button[data-reject-all-privacy-settings]'
    case 'reifentiefpreis.de':
      return '.simplemodal-container .btn_cancel.deny'
    case 'allelectronics.com':
      return '#simplemodal-container #cookie-consent-accept'
    case 'btvnovinite.bg':
      return '.cc_container--open .cc_btn_accept_all'
    case 'konectis.com':
      return _if(
    ...
    case 'ubereats.com':
      return _if(
        ...
        '//div[./div/a[contains(@href, "legal/privacy/cookies")]]/div/div/button'
      )
    case 'ejobs.ro':
      return _chain(
    ...
    case 'pfleiderer.com':
      return '.cc--banner #cookieconsent_save'
    case 'gronkh.tv':
    ...
    case 'kh.hu':
      return '.cookie-dialog:not([style*="top: -"]) .save'
    case 'afbmotorcycles.co.uk':
      return '#cookieModal[style*="block"] .button-orange'
    case 'secondsol.com':
      return '.modal[style*="block"] .btn-success-cookie-blue.btn-ablehnen'
    case 'idoctors.it':
      return '#modal-cookies[style*="block"] + .modal a[href*="conferma"]'
    ...
    case 'kinocheck.de':
      return _chain('.video-gdpr-consent button', '.gdpr-consent .button-red')
    case 'reiseauskunft.insa.de':
      return _chain('#HFS_CookieOptionfunctional', '#HFS_CookieSelectChoice')
    case 'yougov.com':
    ...
    case 'chatreplay.stream':
      return _chain(
        '.blockmetoaccept button:first-child',
        '.custom.option.active:nth-child(2)',
        '.custom.option.active:nth-child(3)',
        '.custom.option.active:nth-child(4)',
        '.blockmetoaccept button:last-child'
      )
    case 'fortune.com':
    ...
    case 'itis.swiss':
      return '#cookie_blocker:not([style*="none"]) #cookie_ok'
    ...
    case 'tournamentsoftware.com':
      return _chain(
        '.message-page #CookiePurposes_1_',
        '.message-page .js-save'
      )
    case 'bokio.se':
      return '#cookiemodal:not(.cookiemodal--hidden) #cookie-dotrack'
    case 'sverigesingenjorer.se':
      return '.cookie-layer--visible .button[class*="accept-nec"]'
    case 'tellows.de':
    ...
    case 'elsevier.com':
      return _chain(
        'button[data-testid="cookie-settings-button"]',
        '.save-preference-btn-handler'
      )
    ...
    case 'infranken.de':
      return 'div[aria-labelledby*="cmpbox"][style*="block"] .cmptxt_btn_yes'
    case 'klasse.be':
    ...
    case 'tommy.hr':
      return _if(
        ...
        '//div[@data-scroll-lock-scrollable][contains(@class, "fixed")]//button[text()="Prihvati odabrano"]'
      )
    case 'tommy.com':
      return _chain(
        '.ReactModal__Content--after-open[class*="CookieNotice"] button:first-child',
        '.ReactModal__Content--after-open[class*="CookieNotice"] button:only-of-type'
      )
    ...
    case 'uswitch.com':
      return 'div[data-include="cookie-banner"][style*="block"] [data-type="save"]'
    case 'idealcountryproperty.com':
      return '.modal[style*="block"] .rwConsentModalConfirm'
    case 'romeo.com':
      return _if(
        '.ReactModal__Content--after-open #cookie_consent_accept_all_button',
        'FLAG:UNIQUE',
        '.ReactModal__Content--after-open button:first-child',
        '.ReactModal__Content--after-open button:first-child'
      )
    case 'soundboks.com':
    ...
    case 'sixt-neuwagen.de':
      return _chain(
        'app-cookie-layer .settings-mode-switch',
        'pl-button[data-e2e="cookie-settings-save"]'
      )
    case 'pons.com':
    ...
    case 'forbes.com':
      return '#lanyard_root button:first-child'
    case 'eurogrow.es':
      return _chain('.mfp-ready #hi-add-cookies', '.hi-cookie-btn-accept')
    case 'caseking.de':
      return _chain('#ckCookieConsentButton', '#ckCookieConsentButton')
    ...
    case 'officiallondontheatre.com':
      return _chain(
        '#cookie-consent > .open .bg-grey',
        '#cookie-consent > .open .bg-booking-orange'
      )
    ...
    case 'france24.com':
      return '.m-em-video__cmp button:last-child'
    case 'bayern.de':
    ...
    case 'foussier.fr':
      return _chain(
        '.ReactModal__Content--after-open[data-id="cookie-consent"] .modal-footer a',
        '.ReactModal__Content--after-open[data-id="cookie-configure"] button.right'
      )
    case 'swissborg.com':
      return _chain(
        'div[data-state="open"][class*="cookies"] button + button',
        'li[class*="cookiesOptionsItem"]:nth-child(2) button',
        'div[data-state="open"][class*="cookies"] button:first-child:not(:only-of-type)'
      )
    case 'anwb.nl':
      return _chain(
        '#TRCO-application .PONCHO-link a',
        '.PONCHO-button--decide[name="save"]'
      )
    case 'shoot-club.de':
    ...
    case 'medal.tv':
      return _if(
        ...
        '//div[./span/a[@href="/cookie-notice"]]/div/div[2]/button'
      )
    case 'voordeeluitjes.nl':
      return '.cookie-banner-new .reject-button'
    case 'brewdog.com':
      return _chain(
        '.fixed button[data-testid="consent-manager-preferences-button"]',
        'input[data-testid*="functional-no"]',
        'input[data-testid*="functional-no"]',
        'input[data-testid*="marketing-no"]',
        'input[data-testid*="advertising-no"]',
        'button[data-testid="consent-manager-preferences-save"]'
      )
    case 'mobiflip.de':
    ...
    case 'hey.car':
      return _if_else(
        ...
        [
          '//div[./p/a/strong[@id="cookie-dashboard-link"]]/following-sibling::div/button',
        ]
      )
    case 'starcar.de':
      return '.MuiModal-root button[class*="consentManager_buttonSecondary"]'
    case 'airbaltic.com':
    ...
    case 'mehilainen.fi':
      return _if(
        '.MuiDialog-root',
        '//div[contains(@class, "MuiDialog-root")]//button[contains(text(), "välttämättömät")]'
      )
    case 'remax.com':
    ...
    case 'vodafone.de':
      return '#dip-consent[style*="block"] #dip-consent-summary-reject-all, .v--modal-overlay .cookie-conf + div .btn:last-child'
    case 'vodafone.com':
      return '#popup-root .allowEssentialCookies'
    case 'finom.co':
      return 'button[data-test="cookie-info-card-continue-without-accepting"], .gdpr-policy [data-test="btn-not-accept"]'
    case 'kayak.pl':
      return '.r9-modal-dialog.active #r9-gdpr-close'
    case 'cowaymega.com':
      return '.cookie-popup:not(.hide) .cookie-popup__submit'
    case 'canyon.com':
      return _chain(
        '.modal.is-open #js-data-privacy-manage-cookies',
        '#js-manage-data-privacy-save-button'
      )
    case 'correos.es':
      return '.sc-correos-cdk-cookies-module:not(.--displayNone) + correos-cdk-pop-up correos-ui-button:nth-child(2) button, .body-fixed #cookieWall #cookiesConfiguration .btn:nth-child(2)'
    ...
    case 'telekom.com':
      return '.cookie-optin-layer [data-cookie-optin-set="none"], .show-overlay .js-accept-button'
    case 'telekom.de':
      return '.ui-dialog[style*="block"] #CookieMessageFace input[value="OK"]'
    case 'telekom.net':
    ...
    case 'empik.com':
      return _chain(
        '.cookies-consent-component__prevent-scroll button[data-ta="cookie-btn-more"]',
        'button[data-ta="cookie-btn-accept-selected"]'
      )
    case 'vmock.com':
      return _chain(
    ...
    case 'calameo.com':
      return '.kookies .btn-refuse'
    case 'autohaus-boettche.de':
      return '.modal[style*="block"] #cookie-consent-deny-all'
    case 'hl.co.uk':
      return '.-cb-open #updateCookieButton'
    case 'temu.com':
      return _if(
        'div[data-scroll="true"]',
        '//div[@data-scroll="true"]//button[contains(., "Reject all")] | //div[@data-scroll="true"]/div[last()]/div[contains(., "Reject all")]'
      )
    case 'zav-sava.si':
      return '.modal[style*="block"] #btn-cookie-man-save'
    case 'sava-osiguranje.hr':
      return _chain('#frmAgree[style*="block"] input', '#btn-agree-go')
    case 'billiger.de':
      return _if(
    ...
    case 'framer.com':
      return _chain(
        'div[class*="CookiesBanner"] button + button',
        'div[class*="Modal_container"] button + button'
      )
    case 'toonpool.com':
      return '.modal[style*="block"] #privacyButton'
    case 'awwwards.com':
      return '.modal.is-visible strong[data-action*="save"]'
    case 'movistar.es':
      return _chain(
    ...
    case 'headspace.com':
      return _if_else(
        '#__next',
        [
          '.ReactModal__Content--after-open[aria-label="gdpr_dialog"] #accept-button',
        ],
        [
          '#analytics-cookie-checkbox input',
          '#marketing-cookie-checkbox input',
          'div[data-testid="gdpr-modal"] form > button',
        ]
      )
    case 'io.google':
      return '[aria-labelledby="cookie-bar-title"] #btn'
    case 'skandia.se':
      return '.i-sticky-open #kakcontainer #cAcceptPart'
    case 'easyswimportal.com':
      return '.btn_accept_cookies'
    ...
    case 'moebel.de':
      return _chain(
        '.ReactModal__Overlay--after-open.uc-modal .uc-text-sand-dune',
        'label[for="functional"]',
        '.uc-settings-modal__footer button'
      )
    case 'auto.ru':
    ...
    case 'labellevie.com':
      return '#popin-modal.show #confidentiality-refuse-all'
    case 'ziekenhuis.nl':
      return '.reveal-overlay[style*="block"] ~ .reveal-overlay .reveal--cookies__button'
    case 'eurowings.com':
    ...
    case 'sj.se':
      return _if(
        '.MuiModal-root [aria-label*="cookies"]',
        '.MuiModal-root button:first-child',
        '.MuiModal-root + .MuiModal-root button[class*="green"]'
      )
    case 'zeichen.tv':
      return '.overlay.visible .cookie-decline'
    case 'delfino.cr':
      return '#__next > div > p:first-child + button:last-child'
    ...
    case 'kaggle.com':
      return _if(
        '#site-content > div:first-child a[href*="cookies"]',
        '#site-content > div:first-child > div > div:last-child > div'
      )
    case 'bytbil.com':
      return '.uk-modal[style*="block"] #privacyModalAcceptBtn'
    case 'deviantart.com':
      return _chain(
    ...
    case 'withings.com':
      return '.cookie_consent_withings:not(.hidden) #cookieBtnSelected, #cookies.active .accept-selection'
    case 'tvgids.nl':
      return _if(
        '#consent-all-target',
    ...
    case 'halebop.se':
      return '.cookie-banner-modal:not([style*="none"]) #btncookieconsent'
    ...
    case 'britishcornershop.co.uk':
      return '#gdpr[style*="block"] .accept'
    case 'librus.pl':
      return _chain(
    ...
    case 'clo3d.com':
      return '.cookie-consent-popup button:first-child'
    ...
    case 'preparegreentea.com':
      return '.wdpu-container .wdpu-hide-forever'
    case 'evangelisch.de':
      return _if(
        '.modal[style*="block"] #togglerNecessary',
        '.modal[style*="block"] .modal-footer button:first-child'
      )
    case 'elvah.de':
      return _if('.vfm--fixed a[href*="privacy"]', '.vfm--fixed a[href="#"]')
    ...
    case 'patient.deuxiemeavis.fr':
      return '.cookies-consent[data-headlessui-state="open"] .refuse-all'
    ...
    case 'rajsvitidel.cz':
      return _chain(
        '.modal[style*="block"] #consent-settings',
        '#consents-deny'
      )
    case 'fit-plus.info':
      return _if(
    ...
    case 'seb.se':
      return 'dialog[open] button[action-accept-prefs]'
    ...
    case 'ovh.com':
      return '.modal[style*="block"] button[data-navi-id="cookie-accept"] + button'
    case 'gasteig.de':
      return 'body[style*="hidden"] > div[data-fragment="cookieBanner"] button[data-target="accept-essential"]'
    case 'wolfspeed.com':
      return _chain(
    ...
    case 'blackboard.com':
      return '.CookieConsent #agree_button'
    case 'smallpdf.com':
      return 'div[class*="rplgd"] > button:first-child'
    case 'salto.fr':
      return 'body > div > aside a[href*="cookies"] + button'
    case 'sreal.at':
      return '.eg_overlay--open button[data-privacy-action="decline"]'
    case 'napster.com':
      return _if(
        '#root > div > div:first-child:not(:only-child) a[href*="privacy"]',
        '#root > div > div:first-child:not(:only-child) button:last-child'
      )
    case 'hornet.com':
      return _if(
    ...
    case 'bitbrain.com':
      return 'div[class*="CookiesManager"] button'
    ...
    case 'knowit.se':
      return '.z-cookie-alert[open] button[data-action*="disableAll"]'
    case 'rittal.com':
      return '.swal2-html-container[style*="block"] .cc-controls button:nth-child(2)'
    case 'rhein-main-steht-auf.de':
      return '.consent-banner-root .accept-consent-all'
    case 'flaschenpost.de':
      return _if(
        '.fp_modal:not([style*="none"])',
        '//div[@class="fp_modal_container"]/div[not(@id)]//button[contains(., "Ablehnen")]'
      )
    case 'vroomly.com':
      return _if(
        '.sticky-top + div + div a[href*="cookies"]',
        '.sticky-top + div + div button:nth-child(2)'
      )
    case 'pro-sec.dk':
    ...
    case 'kbv.de':
      return '.dialog-backdrop.active .reject-all'
    ...
    case 'stevensbikes.de':
      return '#cookiesettings[style*="block"] button[name="minimal"]'
    case 'leslipfrancais.fr':
      return '#nq_cnilbanner_container:not([hidden]) .cnil_banner_button_refuse'
    case 'pracuj.pl':
      return _chain(
        'button[data-test="button-customizeCookie"]',
        'div[data-test="modal-cookie-customize"] button:last-child'
      )
    ...
    case 'bandaancha.eu':
      return '#euCk button'
    case 'learnattack.de':
      return '.ccmodal:not([style*="none"]) .ui-dialog-buttonset button:first-child'
    case 'warsteiner.de':
      return _if(
    ...
    case 'remember.de':
      return '#twt-cookie-consent-modal .accept-cookies button:first-child'
    case 'nettest.cz':
      return '.uk-open #modal-confirm'
    case 'finnair.com':
      return 'fin-cookie-policy #necessary-cookie-btn'
    case 'nperf.com':
      return '.ConsentLayer[style*="visible"] .buttonDecline'
    case 'tokyocheapo.com':
      return '.dialog[open] .tc-cookie-consent p a'
    case 'carry.pl':
      return _chain(
        '.lgcookieslaw_customize_cookies',
        'h2 + .lgcookieslaw-section .lgcookieslaw_slider',
        '#lgcookieslaw-save'
      )
    case 'yachtall.com':
      return _chain(
    ...
    case 'livejasmin.com':
      return _chain(
        '.consent_overlay_show .page-privacy button:last-child',
        'div[data-testid*="PrivacyPreference"] > button:last-child'
      )
    case 'accor.com':
      return '.gdpr-cookie-policy-modal._show #accept-cookie'
    case 'tiwag.at':
    ...
    case 'jobs.ch':
      return _chain(
        '#modal[data-cy="cookie-consent"] button[data-cy*="secondary"]',
        '#modal[data-cy="cookie-consent-options"] button[data-cy*="secondary"]'
      )
    case 'flatspot.pictures':
      return '.cookieShit[style*="flex"] #darkSide'
    case 'vr.fi':
      return 'div[data-testid="cookie-consent-modal"] button[data-testid="necessary"]'
    case 'norli.no':
      return _chain(
    ...
    case 'easyticket.de':
      return _chain(
        '#cookie_consent_popup_wrapper.popup_wrapper_visible #cookie_button_grey',
        '#cookie_button_grey'
      )
    case 'assos.com':
    ...
    case 'nightcafe.studio':
      return _chain(
        '//p[contains(text(), "We use cookies")]/a',
        '//a[text()="Deny non-critical cookies"]'
      )
    case 'smythstoys.com':
      return '#cookieLoad[style*="block"] ~ .modal .savePreference, #colorbox.cookie-popup[style*="block"] .cookie-btn-yes'
    ...
    case 'bionic-reading.com':
      return '.MuiModal-root a[href*="privacy-policy"] + a + button'
    case 'nacex.es':
      return _if(
        '.ui-dialog .link_cookies',
        '.ui-dialog #cancel',
        '.ui-dialog #rechazar',
        '.ui-dialog #dialog-cookie + div button'
      )
    case 'towerhousewares.co.uk':
      return '#cookiew[style*="block"] .opt-out'
    case 'hoyer.de':
      return _chain(
        '.backdrop button[data-gtag="consent:show-details"]',
        'button[data-gtag="consent:save-selection"]'
      )
    case 'kufar.by':
      return '//div[./div/h3[text()="Политика обработки cookie"]]//button'
    case 'sq.gouv.qc.ca':
    ...
    case 'akelius.com':
      return '.cdk-overlay-containerweb-cookie-manager-dialog button:first-child'
    case 'av-atlas.org':
      return '.cdk-overlay-container gdpr-bottom-sheet .mat-primary'
    case 'technomarket.bg':
      return '.cdk-overlay-container tm-terms-consent .primary'
    case 'fiberplane.com':
    ...
    case 'biker-boarder.de':
      return '.modal.open #approve_all_nothing'
    case 'leserservice.ch':
      return '#gdpr-cookie-block #btn-cookie-disallow, #amgdprcookie-btn-save'
    case 'you-ladies.de':
      return '.cookie-notice-dsvgo a[href*="accept-cookies?redirect"]'
    case 'robertsspaceindustries.com':
      return '.c-modal button[aria-label*="refuse"]'
    case 'mojelekarna.cz':
    ...
    case 'bokadirekt.se':
      return _if(
        '.ReactModal__Content--after-open a[href*="articles/cookies"]',
        '.ReactModal__Content--after-open button'
      )
    case 'bol.com':
      return '.modal[open] #js-reject-all-button, .modal[open] .js-decline-button, #__next button[class*="CookieModal"]:first-child, div[data-componentid*="cookie-popup"] button:first-child'
    case 'blaetterkatalog.welt.de':
      return '#nagme #cbutton1'
    case 'jps.de':
      return '.cookieModal[style*="block"] .contentBlock > button:last-child'
    case 'maisonstandards.com':
      return _chain(
        '.popin_consent_customise',
        '.popin_collapsable_box:nth-child(2) button:first-child',
        '.popin_collapsable_box:nth-child(3) button:first-child',
        '.popin_consent_submit + .popin_consent_customise'
      )
    ...
    case 'svt.se':
      return '.nyh_cookie-consent div[class*="CookieConsent__footer"] > button:nth-child(2)'
    case 'nyiron.hu':
      return _if(
        '.ZebraDialog',
    ...
    case 'amara.org':
      return _chain('#cookie-consent-details-input', '#accept-manage-cookies')
    ...
    case 'canalplus.com':
      return '#modal-overlayer-cookie-banner.is--show button[data-overlayer-closebtn], .p-dialog-visible .cookies__header-cancel .btn'
    case 'metzler.com':
      ...
      var clickCounter = 0,
        clickLoop = setInterval(function () {
          ...
          if (
            ...
            if (clickCounter > 50) clearInterval(clickLoop)
          }
        }, 200)
    } else if (counter < 200) searchLoop(counter + 1, host)
  }, timeoutDuration)
...
;(function () {
  var start = setInterval(function () {
    ...
    if (!html || html.className.indexOf(classname) !== -1) return
